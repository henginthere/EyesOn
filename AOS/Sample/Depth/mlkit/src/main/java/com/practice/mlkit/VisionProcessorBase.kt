...
import com.practice.mlkit.VisionImageProcessor
import android.app.ActivityManager
import android.content.Context
import com.practice.mlkit.ScopedExecutor
import com.practice.mlkit.VisionProcessorBase.OnProcessingCompleteListener
import com.practice.mlkit.FrameMetadata
...
import com.practice.mlkit.BitmapUtils
...
import com.practice.mlkit.CameraImageGraphic
import com.practice.mlkit.InferenceInfoGraphic
...
abstract class VisionProcessorBase<T> protected constructor(context: Context) :
    ...
    fun setOnProcessingCompleteListener(onProcessingCompleteListener: OnProcessingCompleteListener?) {
    ...
    private fun setUpListener(
        ...
        return task.addOnSuccessListener(
            ...
            .addOnCompleteListener(executor) { results: Task<T>? ->
